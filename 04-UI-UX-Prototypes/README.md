...
![Hình 3.2. Giao diện đăng nhập](./Hinh_3_2_Dang_Nhap.png)
*Hình 3.2. Giao diện đăng nhập*

![Hình 3.3. Giao diện Trang chủ (Dashboard)](./Hinh_3_3_Trang_Chu.png)
*Hình 3.3. Giao diện Trang chủ (Dashboard)*

---

### Quản lý Hồ sơ Bệnh nhân
![Hình 3.4. Giao diện quản lý bệnh nhân](./Hinh_3_4_Quan_Ly_Benh_Nhan.png)
*Hình 3.4. Giao diện quản lý bệnh nhân*

![Hình 3.5. Giao diện thêm bệnh nhân mới](./Hinh_3_5_Them_Benh_Nhan.png)
*Hình 3.5. Giao diện thêm bệnh nhân mới*

---

### Quản lý Bác sĩ & Khoa khám
![Hình 3.6. Giao diện quản lý bác sĩ](./Hinh_3_6_Quan_Ly_Bac_Si.png)
*Hình 3.6. Giao diện quản lý bác sĩ*

![Hình 3.7. Giao diện thêm bác sĩ mới](./Hinh_3_7_Them_Bac_Si.png)
*Hình 3.7. Giao diện thêm bác sĩ mới*

![Hình 3.8. Giao diện quản lý khoa khám](./Hinh_3_8_Quan_Ly_Khoa_Kham.png)
*Hình 3.8. Giao diện quản lý khoa khám*

---

### Quản lý Lịch làm việc & Lịch hẹn
![Hình 3.9. Giao diện quản lý lịch làm việc](./Hinh_3_9_Quan_Ly_Lich_Lam_Viec.png)
*Hình 3.9. Giao diện quản lý lịch làm việc*

![Hình 3.10. Giao diện thêm lịch làm việc mới](./Hinh_3_10_Them_Lich_Lam_Viec.png)
*Hình 3.10. Giao diện thêm lịch làm việc mới*

![Hình 3.11. Giao diện quản lý lịch hẹn](./Hinh_3_11_Quan_Ly_Lich_Hen.png)
*Hình 3.11. Giao diện quản lý lịch hẹn*

---

### Quản lý Thanh toán
![Hình 3.12 Giao diện quản lý thanh toán](./Hinh_3_12_Quan_Ly_Thanh_Toan.png)
